...
-   :material-television: **[HDR Content](hdr-content.md)**
    ...
    *passthrough* in the player is still disabled for stability as of
    v0.1.22-alpha — see the page for details.
...
**v0.1.22-alpha — released 2026-09-13.**

[:material-download: Download v0.1.22-alpha (Windows / macOS)](https://github.com/liquid-releasing/forgeplayer-releases/releases/latest){ .md-button .md-button--primary }
